...
### Experience
- **Dealground | Intern** (June 2025 - January 2026)
  + Created web scraping agents for property data.
  + Improved Chrome extension functionality.
- **Rochester Institute of Technology | Student Lab Instructor** (August 2024 - May 2025)
  + Tutored students on concepts in Java and Python.
  + Automated grading with bash scripting.
